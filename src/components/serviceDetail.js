...
const ServiceDetail = () => {
    const servicesList = [
        ...
        "Album Designing for Weddings & Real Estate",
        "Photo Editing, Retouching",
        "Craft Memorable Flyers",
        "Brochures and Infographics Designs",
        "Design Business Cards for Billboards",
        "Food Menu Design Services",
        "Design Your Letterhead and Resume",
    ];
    ...
    const handleDownload = (type) => {
        // Replace with the actual path to your files in the public/assets folder
                ...
                <Row>
                    ...
                    <Col lg={8}>
                        <div className="sd-content-section">
                            <img src={mainImg} alt="Graphic Design Main" className="sd-main-image" />
                            
                            <h2 className="sd-section-title">Creative Design Solutions for Your Brand</h2>
                            <p className="sd-text">
                                Our graphic design services are crafted to elevate your brand's visual identity. We combine creativity with strategy to deliver stunning visuals that communicate your message effectively. From logo creation to complete brand overhauls, we ensure every pixel serves a purpose. Our team specializes in creating cohesive brand experiences across digital and print platforms, ensuring your business stands out in a crowded marketplace.
                            </p>
                            <p className="sd-text">
                            ...
                            <div className="sd-advantage-box" style={{ display: 'block' }}>
                                <img src={advantageImg} alt="Design Advantage" className="sd-advantage-img" style={{ width: '100%', marginBottom: '20px' }} />
                            ...
                            <div className="sd-widget">
                                ...
                                <div className="sd-service-menu">
                                    {servicesList.map((item, index) => (
                                        <a key={index} href="#!" className="sd-service-link">
                                            {item}
                                        </a>
                                    ))}
                                </div>
